...
public class WhatsAppStatusCleanerAudioAdapter extends Adapter<ViewHolder> {
    ...
    public WhatsAppStatusCleanerAudioAdapter(Context context, ArrayList<ModelWhatsAppStatus> arrayList, int i, String what) {
    ...
    private class WhatsAppStatusViewHolder extends ViewHolder {
        ...
        public WhatsAppStatusViewHolder(View view) {
            ...
            view.setOnClickListener(new OnClickListener() {
                public void onClick(View view) {
                    if (WhatsAppStatusCleanerAudioAdapter.WhatsAppStatusViewHolder.this.getAdapterPosition() != -1 && onAdapterListener != null) {
                        onAdapterListener.onItemClick(WhatsAppStatusCleanerAudioAdapter.WhatsAppStatusViewHolder.this.getAdapterPosition());
                    }
                }
            });
        ...
        private void bind(final int i) {
            ...
            if (WhatsAppStatusCleanerAudioAdapter.isVideoFile(modelWhatsAppStatus.filePath)) {
